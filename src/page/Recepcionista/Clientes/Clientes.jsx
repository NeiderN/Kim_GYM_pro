    ...
    <div className="cli-root">
      ...
      <aside className="cli-sidebar">
          ...
          <div key={group.section} className="cli-nav-group">
            ...
            {group.items.map((item) => (
              ...
              >
                ...
                <span className="cli-nav-label">{item.label}</span>
                {item.locked && <span className="cli-lock-icon">🔒</span>}
              </button>
            ))}
          </div>
        ))}
        ...
        <div className="cli-sidebar-user">
          <div className="cli-avatar">AN</div>
          <div className="cli-user-info">
            <span className="cli-user-name">Ana Nuñez</span>
            <span className="cli-user-role">Recepcionista</span>
          </div>
                  ...
                  <tr key={c.doc}>
                    ...
                    <td>
                      <div className="cli-actions">
                        <button className="cli-btn cli-btn--ver" onClick={() => navigate(`/recepcion/clientes/${c.doc}`)}>Ver</button>
