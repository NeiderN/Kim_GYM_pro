    ...
    <div className="pf-root">
      ...
      <aside className="pf-sidebar">
          ...
          {NAV_ITEMS.map((group) => (
            <div key={group.section} className="pf-nav-group">
              ...
              {group.items.map((item) => (
                ...
                >
                    <span className="pcli-nav-icon">{item.icon}</span>
                    <span className="pcli-nav-label">{item.label}</span>
                    {item.locked && <span className="pcli-lock-icon">🔒</span>}
                </button>
              ))}
            </div>
          ))}
        ...
        <div className="pf-sidebar-user">
          <div className="pf-avatar-sidebar">AN </div>
          <div className="pf-user-info">
            <span className="pf-user-name">Ana Nuñez</span>
            <span className="pf-user-role">Recepcionista</span>
          </div>
      ...
      <div className="pf-main">
        ...
        <header className="pf-topbar">
          <div className="pf-topbar-left">
            <button className="pf-back-btn" onClick={() => navigate("/recepcion/clientes")}>
              ←
            </button>
            <h1 className="pf-page-title">PERFIL CLIENTE</h1>
          </div>
          <div className="pf-topbar-right">
            <button className="pf-btn pf-btn--edit" onClick={() => navigate(`/recepcion/clientes/ ${id}/editar`)}>
              ✏️ Editar
            </button>
          </div>
        </header>
